...
ActiveRecord::Schema.define(version: 2020_05_17_103821) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["user_id", "progress_id", "created_at"], name: "index_comments_on_user_id_and_progress_id_and_created_at"
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.index ["user_id", "portfolio_id"], name: "index_favorites_on_user_id_and_portfolio_id", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "engineer", default: true
